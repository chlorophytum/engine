...
const IP2Sh = LibFunc("IdeographProgram::IP2Sh", function*(e) {
...
export const HintMultipleStrokesGiveUp = LibFunc(
	"IdeographProgram::HintMultipleStrokesGiveUp",
	function*(e) {
...
export const HintMultipleStrokesSimple = LibFunc(
	"IdeographProgram::HintMultipleStrokesSimple",
	function*(e) {
		const [N, zBot, zTop, vpZMids] = e.args(4);
		const pZMids = e.coerce.fromIndex.variable(vpZMids);
		yield e.mdap(zBot);
